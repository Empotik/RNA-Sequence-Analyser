...
# Developed by:
#   Puttisan Mukneam
#       Majored in Data Science - Claremont McKenna College, Pitzer College
# 
#   Jeerakit Kanokthipphayakun
#       Majored in Electrical and Computer Engineering - College of Engineering and Applied Science,
#       Minored in Business - Leeds School of Business, University of Colorado Boulder
# 
...
╚══════╝╚═╝     ╚═╝╚═╝      ╚═════╝    ╚═╝   ╚═╝╚═╝  ╚═╝
                                                        '''
    print(welcome)    
    print("Welcome to RNA Sequence Matcher v3.1")
    print("------------------------------------")
